    ...
    <div >
            ...
            <div className='flex flex-col gap-2 justify-between items-center'>
                ...
                <div className='mt-3 w-full'>
                        ...
                        className='w-full flex justify-center text-white font-semibold p-2 bg-[#3e8670] rounded-lg'>Complete Ride </Link>
